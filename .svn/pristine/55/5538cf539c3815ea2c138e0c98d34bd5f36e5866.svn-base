...
<html>
	...
	<body>
		...
		<table>
				...
				<tr>
					<td colspan="2" class="tdHeader"><s:property value="question.title" /></td>
				</tr>
				<tr>
					<td colspan="2" class="tdWhiteLine"></td>
				</tr>
				<tr>
					<td colspan="2" style="float: left;display: inline">
						<!-- 创建左上角颜色块,用不同颜色代表不同下拉列表选项 -->
						<s:iterator value="question.matrixSelectOptionArr" status="optst">
							<!-- 对文本框进行修饰,产生颜色块的特效 -->
				...
				<tr>
					<td>
						<table>
							...
							<!-- 遍历行标题数组 -->
							<s:iterator var="row" value="question.matrixRowTitleArr" status="rst">
								<tr>
									<td><s:property /></td>
									<!--  遍历列表数组 -->
									<s:iterator var="col" value="question.matrixColTitleArr" status="cst">
										<td style="text-align: left;">
											<!-- 遍历下拉选项数组 -->
											<s:iterator var="option" value="question.matrixSelectOptionArr" status="optst">
