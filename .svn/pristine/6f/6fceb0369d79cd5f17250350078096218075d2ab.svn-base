			...
			<tr>
				<td style="vertical-align: top;">
					<table>
						<tr>
							<td>
								<s:form id="form1" action="saveOrUpdateRole" namespace="/role" method="post">
								<s:hidden name="role.id" />
								<table>
									<tr>
										<td class="tdFormLabel" width="200px">角色名称</td>
										<td class="tdFormControl"><s:textfield name="role.roleName" cssClass="text" /></td>
									</tr>
									<tr>
										<td class="tdFormLabel" width="200px">角色值</td>
										<td class="tdFormControl"><s:textfield name="role.roleValue" cssClass="text" /></td>
									</tr>
									<tr>
										<td class="tdFormLabel" width="200px">角色描述</td>
										<td class="tdFormControl"><s:textarea name="role.roleDesc" cssClass="text" rows="10"/></td>
									</tr>
									<tr>
