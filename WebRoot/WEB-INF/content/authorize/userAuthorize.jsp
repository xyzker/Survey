			...
			<tr>
				<td style="vertical-align: top;">
					<table>
						<tr>
							<td>
								<s:form action="updateAuthorize" namespace="/authorize" method="post">
								<s:hidden name="user.id" />
								<table>
									<tr>
										<td class="tdFormLabel" width="200px">email</td>
										<td class="tdFormControl"><s:textfield name="user.email" cssClass="text" disabled="true"/></td>
									</tr>
									<tr>
										<td class="tdFormLabel" width="200px">nickName</td>
										<td class="tdFormControl"><s:textfield name="user.nickName" cssClass="text"  disabled="true"/></td>
									</tr>
									<tr>
