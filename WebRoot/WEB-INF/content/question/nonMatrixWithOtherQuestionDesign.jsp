	...
	<body>
		...
		<table>
			...
			<tr>
				...
				<td width="*" style="text-align: left;"><s:checkbox name="question.other" /></td>
			</tr>
			<tr>
				<td style="text-align: right;">"其它"项类型:</td>
				<td width="*" style="text-align: left;">
					<s:radio list="#{0:'无',1:'文本框',2:'下拉列表框'}" listKey="key" listValue="value" name="question.otherStyle" />
				</td>
			</tr>
			<tr>
				<td style="text-align: right;vertical-align: top;">"其它"项下拉列表选项:</td>
				<td width="*" style="text-align: left;"><s:textarea cols="41" rows="8" name="question.otherSelectOptions" /></td>
			</tr>
			<tr>
